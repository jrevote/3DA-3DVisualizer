/***********************************************************************
CloudValue - Structure to represent data values stored in NASA Cloud
files.
...
/*******************************************
Memory representation of Cloud file values:
*******************************************/
...
struct CloudValue
	...
	/* Methods: */
	friend CloudValue affineCombination(const CloudValue& v1,const CloudValue& v2,float weight2)
		{
...
inline
void
swapEndianness(Visualization::Concrete::CloudValue& value)
	{
...
/***********************************************************
Specialized value extractor classes for CloudValue objects:
***********************************************************/

template <class ScalarParam>
class ScalarExtractor<ScalarParam,Visualization::Concrete::CloudValue>
	{
	/* Embedded classes: */
	public:
	...
	typedef Visualization::Concrete::CloudValue SourceValue; // Source value type
...
class VectorExtractor<VectorParam,Visualization::Concrete::CloudValue>
	{
	/* Embedded classes: */
	public:
...
/*********************************************
Data value descriptor class for Cloud values:
*********************************************/

template <class DataSetParam>
class CloudDataValue:public Visualization::Wrappers::DataValue<DataSetParam,float>
	{
	/* Embedded classes: */
	public:
