...
#ifndef VISUALIZATION_CONCRETE_MARGARETESUBDUCTIONFILE_INCLUDED
#define VISUALIZATION_CONCRETE_MARGARETESUBDUCTIONFILE_INCLUDED

#include <Wrappers/CurvilinearIncludes.h>
#include <Concrete/MargareteSubductionValue.h>
...
typedef MargareteSubductionValue Value; // Memory representation of data set value
typedef Visualization::Templatized::Curvilinear<Scalar,3,Value> DS; // Templatized data set type
typedef MargareteSubductionDataValue<DS> DataValue; // Type of data value descriptor
typedef Visualization::Wrappers::Module<DS,DataValue> BaseModule; // Module base class type

}

class MargareteSubductionFile:public BaseModule
	{
	/* Constructors and destructors: */
	public:
	MargareteSubductionFile(void); // Default constructor
