...
class Algorithm
	...
	public:
	Algorithm(Comm::MulticastPipe* sPipe) // Creates algorithm to own the given pipe
		:pipe(sPipe)
		{
		}
	private:
	...
	virtual bool continueSlaveElement(void); // Receives a fragment of a visualization element on the slave node(s) of a cluster environment; returns true if element is complete
	};
