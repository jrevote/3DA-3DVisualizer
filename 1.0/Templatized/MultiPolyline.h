...
class MultiPolyline:public GLObject
	...
	bool receive(void); // Receives polyline data via multicast pipe; returns true when polyline is fully received
	...
	void finish(void); // Finishes adding vertices to the polyline
