...
class MultiStreamlineExtractor:public Visualization::Abstract::Algorithm
	...
	typedef MultiStreamline<DataSetWrapper> MultiStreamline; // Type of created visualization elements
	...
	public:
	MultiStreamlineExtractor(const GLColorMap* sColorMap,const Visualization::Abstract::DataSet* sDataSet,const Visualization::Abstract::VectorExtractor* sVectorExtractor,const Visualization::Abstract::ScalarExtractor* sScalarExtractor,Visualization::Abstract::DataSet::Scalar sDiskRadius,Comm::MulticastPipe* sPipe); // Creates a streamline extractor for the given data set, vector extractor, and auxiliary scalar extractor
