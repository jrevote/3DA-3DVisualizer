...
#ifndef VISUALIZATION_CONCRETE_UNDERWORLDVALUE_INCLUDED
#define VISUALIZATION_CONCRETE_UNDERWORLDVALUE_INCLUDED
...
struct UnderworldValue
	...
	/* Methods: */
	friend UnderworldValue affineCombination(const UnderworldValue& v1,const UnderworldValue& v2,float weight2)
		{
		float weight1=1.0f-weight2;
		UnderworldValue result;
...
inline
void
swapEndianness(Visualization::Concrete::UnderworldValue& value)
	{
...
/***********************************************************
Specialized value extractor classes for UnderworldValue objects:
***********************************************************/

template <class ScalarParam>
class ScalarExtractor<ScalarParam,Visualization::Concrete::UnderworldValue>
	{
	/* Embedded classes: */
	public:
	...
	typedef Visualization::Concrete::UnderworldValue SourceValue; // Source value type
...
class VectorExtractor<VectorParam,Visualization::Concrete::UnderworldValue>
	{
	/* Embedded classes: */
	public:
...
class UnderworldDataValue:public Visualization::Wrappers::DataValue<DataSetParam,float>
	{
	/* Embedded classes: */
	public:
