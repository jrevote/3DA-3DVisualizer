...
class Visualizer:public Vrui::Application
	...
	class ScalarEvaluationLocator:public EvaluationLocator // Class to evaluate scalar properties of a data set
		...
		/* Elements: */
		private:
		ScalarExtractor* scalarExtractor; // Extractor for the evaluated scalar value
	...
	class VectorEvaluationLocator:public EvaluationLocator // Class to evaluate vector properties of a data set
		...
		/* Elements: */
		private:
		ScalarExtractor* scalarExtractor; // Extractor for the evaluated scalar value (to color arrow rendering)
		GLColorMap* colorMap; // Color map for the evaluated scalar value
		VectorExtractor* vectorExtractor; // Extractor for the evaluated vector value
	...
	char* colorMapName; // File name to load new color maps from
	GLColorMap** colorMaps; // An array of one color map for each scalar value in a data set
	ScalarExtractor* scalarExtractor; // A scalar extractor for the data set
	VectorExtractor* vectorExtractor; // A vector extractor for the data set
	...
	int scalarVariable; // The currently selected scalar variable
	int vectorVariable; // The currently selected vector variable
	...
	GLMotif::ColorBar* colorBar; // Color bar widget
	PaletteEditor* paletteEditor; // Editor for color maps
	PaletteEditor::Storage** palettes; // Array of pointers to palettes for each scalar value in a data set
	...
	GLMotif::PopupWindow* createColorBarDialog(void);
	void addElement(Element* newElement); // Adds a new visualization element to the list
	void selectScalarVariable(int newScalarVariable); // Selects the given scalar variable and updates related state
