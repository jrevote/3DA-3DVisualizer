...
#ifndef VISUALIZATION_TEMPLATIZED_GOCADGRIDRENDERER_INCLUDED
#define VISUALIZATION_TEMPLATIZED_GOCADGRIDRENDERER_INCLUDED
...
class GocadGridRenderer
	...
	public:
	GocadGridRenderer(const DataSet* sDataSet); // Creates a renderer for the given data set
...
#ifndef VISUALIZATION_TEMPLATIZED_GOCADGRIDRENDERER_IMPLEMENTATION
#include <Templatized/GocadGridRenderer.cpp>
#endif
