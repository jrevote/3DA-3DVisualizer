...
const double EarthRenderer::flatteningFactor=1.0/298.247;
...
EarthRenderer::EarthRenderer(double sScaleFactor,const std::string& sSurfaceTextureFileName)
	:scaleFactor(sScaleFactor),
	 f(flatteningFactor),
	 surfaceTextureFileName(sSurfaceTextureFileName),
	 surfaceDetail(2),
...
void EarthRenderer::initContext(GLContextData& contextData) const
	...
	Images::RGBImage earthTexture=Images::readImageFile(surfaceTextureFileName.c_str());
