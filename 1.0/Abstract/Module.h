...
class Module:public Plugins::Factory
	...
	/* Methods: */
	virtual DataSet* load(const std::vector<std::string>& args) const =0; // Loads a data set from the given list of arguments
	...
	virtual Algorithm* getScalarAlgorithm(int scalarAlgorithmIndex,const GLColorMap* colorMap,const DataSet* dataSet,const ScalarExtractor* scalarExtractor,Comm::MulticastPipe* pipe) const; // Returns the given visualization algorithm
	...
	virtual Algorithm* getVectorAlgorithm(int vectorAlgorithmIndex,const GLColorMap* colorMap,const DataSet* dataSet,const VectorExtractor* vectorExtractor,const ScalarExtractor* scalarExtractor,Comm::MulticastPipe* pipe) const; // Returns the given visualization algorithm
	};
