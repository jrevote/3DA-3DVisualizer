...
#ifndef VISUALIZATION_SLICEDHEXAHEDRALRENDERER_INCLUDED
#define VISUALIZATION_SLICEDHEXAHEDRALRENDERER_INCLUDED
...
class DataSetRenderer<SlicedHexahedral<ScalarParam,dimensionParam,ValueParam> >
	{
	/* Embedded classes: */
	public:
	typedef SlicedHexahedral<ScalarParam,dimensionParam,ValueParam> DataSet; // Type of rendered data set
