...
class MultiStreamline:public Visualization::Abstract::Element
	...
	public:
	MultiStreamline(unsigned int sNumStreamlines,const GLColorMap* sColorMap,Comm::MulticastPipe* pipe); // Creates an empty multi-streamline for the given color map
	private:
	...
	/* Methods: */
	unsigned int getNumStreamlines(void) const // Returns the number of related streamlines
		{
		return multiPolyline.getNumPolylines();
		}
