...
class SeededIsosurfaceExtractor:public Visualization::Abstract::Algorithm
	...
	public:
	SeededIsosurfaceExtractor(const GLColorMap* sColorMap,const Visualization::Abstract::DataSet* sDataSet,const Visualization::Abstract::ScalarExtractor* sScalarExtractor,Comm::MulticastPipe* sPipe); // Creates an isosurface extractor for the given data set and scalar extractor
