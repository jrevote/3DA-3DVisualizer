...
inline
SimplicalHexahedral<ScalarParam,dimensionParam,ValueParam>::EdgeID::EdgeID(
	const typename SimplicalHexahedral<ScalarParam,dimensionParam,ValueParam>::GridVertex* v0,
	const typename SimplicalHexahedral<ScalarParam,dimensionParam,ValueParam>::GridVertex* v1)
	{
...
inline
typename SimplicalHexahedral<ScalarParam,dimensionParam,ValueParam>::Vector
SimplicalHexahedral<ScalarParam,dimensionParam,ValueParam>::Cell::calcVertexGradient(
	int vertexIndex,
...
template <class ScalarParam,int dimensionParam,class ValueParam>
inline
typename SimplicalHexahedral<ScalarParam,dimensionParam,ValueParam>::EdgeID
SimplicalHexahedral<ScalarParam,dimensionParam,ValueParam>::Cell::getEdgeID(
	int edgeIndex) const
	{
...
template <class ScalarParam,int dimensionParam,class ValueParam>
inline
typename SimplicalHexahedral<ScalarParam,dimensionParam,ValueParam>::Point
SimplicalHexahedral<ScalarParam,dimensionParam,ValueParam>::Cell::calcEdgePosition(
	int edgeIndex,
	SimplicalHexahedral<ScalarParam,dimensionParam,ValueParam>::Scalar weight) const
	{
...
template <class ScalarParam,int dimensionParam,class ValueParam>
inline
SimplicalHexahedral<ScalarParam,dimensionParam,ValueParam>::Locator::Locator(
	const SimplicalHexahedral<ScalarParam,dimensionParam,ValueParam>* sDs,
	typename SimplicalHexahedral<ScalarParam,dimensionParam,ValueParam>::Scalar sEpsilon)
	:Cell(sDs,0),
...
inline
void
SimplicalHexahedral<ScalarParam,dimensionParam,ValueParam>::Locator::setEpsilon(
	typename SimplicalHexahedral<ScalarParam,dimensionParam,ValueParam>::Scalar newEpsilon)
	{
	epsilon=newEpsilon;
...
inline
bool
SimplicalHexahedral<ScalarParam,dimensionParam,ValueParam>::Locator::locatePoint(
	const typename SimplicalHexahedral<ScalarParam,dimensionParam,ValueParam>::Point& position,
	bool traceHint)
	{
...
SimplicalHexahedral<ScalarParam,dimensionParam,ValueParam>::Locator::calcValue(
...
inline
typename SimplicalHexahedral<ScalarParam,dimensionParam,ValueParam>::Vector
SimplicalHexahedral<ScalarParam,dimensionParam,ValueParam>::Locator::calcGradient(
	const ScalarExtractorParam& extractor) const
	{
...
inline
void
SimplicalHexahedral<ScalarParam,dimensionParam,ValueParam>::connectCells(
	void)
	{
...
template <class ScalarParam,int dimensionParam,class ValueParam>
inline
SimplicalHexahedral<ScalarParam,dimensionParam,ValueParam>::SimplicalHexahedral(
	void)
...
template <class ScalarParam,int dimensionParam,class ValueParam>
inline
typename SimplicalHexahedral<ScalarParam,dimensionParam,ValueParam>::GridVertexIterator
SimplicalHexahedral<ScalarParam,dimensionParam,ValueParam>::addVertex(
	const typename SimplicalHexahedral<ScalarParam,dimensionParam,ValueParam>::Point& pos,
	const typename SimplicalHexahedral<ScalarParam,dimensionParam,ValueParam>::Value& value)
	{
	/* Create a new vertex: */
	++totalNumVertices;
...
template <class ScalarParam,int dimensionParam,class ValueParam>
inline
typename SimplicalHexahedral<ScalarParam,dimensionParam,ValueParam>::CellIterator
SimplicalHexahedral<ScalarParam,dimensionParam,ValueParam>::addCell(
	typename SimplicalHexahedral<ScalarParam,dimensionParam,ValueParam>::GridVertexIterator cellVertices[])
	{
	/* Create a new cell: */
	++totalNumCells;
...
inline
void
SimplicalHexahedral<ScalarParam,dimensionParam,ValueParam>::finalizeGrid(
	void)
	{
...
inline
void
SimplicalHexahedral<ScalarParam,dimensionParam,ValueParam>::setLocatorEpsilon(
	typename SimplicalHexahedral<ScalarParam,dimensionParam,ValueParam>::Scalar newLocatorEpsilon)
	{
...
template <class ScalarParam,int dimensionParam,class ValueParam>
inline
typename SimplicalHexahedral<ScalarParam,dimensionParam,ValueParam>::Scalar
SimplicalHexahedral<ScalarParam,dimensionParam,ValueParam>::calcAverageCellSize(
	void) const
	{
