/***********************************************************************
FITSFile - Class to encapsulate operations on FITS files.
...
#ifndef VISUALIZATION_CONCRETE_FITSFILE_INCLUDED
#define VISUALIZATION_CONCRETE_FITSFILE_INCLUDED
...
class FITSFile:public BaseModule
	{
	/* Constructors and destructors: */
	public:
	FITSFile(void); // Default constructor
