...
#ifndef VISUALIZATION_CONCRETE_CITCOMSGLOBALASCIIFILE_INCLUDED
#define VISUALIZATION_CONCRETE_CITCOMSGLOBALASCIIFILE_INCLUDED
...
class CitcomSGlobalASCIIFile:public BaseModule
	{
	/* Constructors and destructors: */
	public:
	CitcomSGlobalASCIIFile(void); // Default constructor
