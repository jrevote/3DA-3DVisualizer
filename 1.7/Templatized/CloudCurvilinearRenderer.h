...
#ifndef VISUALIZATION_CLOUDCURVILINEARRENDERER_INCLUDED
#define VISUALIZATION_CLOUDCURVILINEARRENDERER_INCLUDED
...
class DataSetRenderer<SlicedCurvilinear<ScalarParam,dimensionParam,ValueScalarParam> >:public CloudGridRenderer<SlicedCurvilinear<ScalarParam,dimensionParam,ValueScalarParam> >
	{
	...
	DataSetRenderer(const SlicedCurvilinear<ScalarParam,dimensionParam,ValueScalarParam>* sDataSet) // Creates a renderer for the given data set
		:CloudGridRenderer<SlicedCurvilinear<ScalarParam,dimensionParam,ValueScalarParam> >(sDataSet)
		{
		}
	};
