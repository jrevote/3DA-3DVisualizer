...
#ifndef VISUALIZATION_CONCRETE_CITCOMCUCARTESIANRAWFILE_INCLUDED
#define VISUALIZATION_CONCRETE_CITCOMCUCARTESIANRAWFILE_INCLUDED
...
class CitcomCUCartesianRawFile:public BaseModule
	{
	/* Constructors and destructors: */
	public:
	CitcomCUCartesianRawFile(void); // Default constructor
