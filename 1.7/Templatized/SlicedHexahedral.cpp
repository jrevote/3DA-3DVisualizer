...
#define VISUALIZATION_TEMPLATIZED_SLICEDHEXAHEDRAL_IMPLEMENTATION
...
#include <Templatized/SlicedHexahedral.h>
...
/*******************************************
Methods of class SlicedHexahedral::GridCell:
*******************************************/

template <class ScalarParam,int dimensionParam,class ValueScalarParam>
inline
SlicedHexahedral<ScalarParam,dimensionParam,ValueScalarParam>::GridCell::GridCell(
	void)
	{
...
/***************************************
Methods of class SlicedHexahedral::Cell:
***************************************/

template <class ScalarParam,int dimensionParam,class ValueScalarParam>
inline
typename SlicedHexahedral<ScalarParam,dimensionParam,ValueScalarParam>::Point
SlicedHexahedral<ScalarParam,dimensionParam,ValueScalarParam>::Cell::calcEdgePosition(
	int edgeIndex,
	SlicedHexahedral<ScalarParam,dimensionParam,ValueScalarParam>::Scalar weight) const
	{
...
/******************************************
Methods of class SlicedHexahedral::Locator:
******************************************/

template <class ScalarParam,int dimensionParam,class ValueScalarParam>
inline
bool
SlicedHexahedral<ScalarParam,dimensionParam,ValueScalarParam>::Locator::newtonRaphsonStep(
	const typename SlicedHexahedral<ScalarParam,dimensionParam,ValueScalarParam>::Point& position)
	{
...
template <class ScalarParam,int dimensionParam,class ValueScalarParam>
inline
SlicedHexahedral<ScalarParam,dimensionParam,ValueScalarParam>::Locator::Locator(
	void)
	:cantTrace(true)
	{
	}
...
inline
SlicedHexahedral<ScalarParam,dimensionParam,ValueScalarParam>::Locator::Locator(
	const SlicedHexahedral<ScalarParam,dimensionParam,ValueScalarParam>* sDs,
	typename SlicedHexahedral<ScalarParam,dimensionParam,ValueScalarParam>::Scalar sEpsilon)
	:Cell(sDs),
...
inline
void
SlicedHexahedral<ScalarParam,dimensionParam,ValueScalarParam>::Locator::setEpsilon(
	typename SlicedHexahedral<ScalarParam,dimensionParam,ValueScalarParam>::Scalar newEpsilon)
	{
	epsilon=newEpsilon;
...
inline
bool
SlicedHexahedral<ScalarParam,dimensionParam,ValueScalarParam>::Locator::locatePoint(
	const typename SlicedHexahedral<ScalarParam,dimensionParam,ValueScalarParam>::Point& position,
	bool traceHint)
	{
...
SlicedHexahedral<ScalarParam,dimensionParam,ValueScalarParam>::Locator::calcValue(
...
SlicedHexahedral<ScalarParam,dimensionParam,ValueScalarParam>::Locator::calcGradient(
	const ScalarExtractorParam& extractor) const
	{
...
/*********************************
Methods of class SlicedHexahedral:
*********************************/

template <class ScalarParam,int dimensionParam,class ValueScalarParam>
inline
void
SlicedHexahedral<ScalarParam,dimensionParam,ValueScalarParam>::resizeSlices(
...
template <class ScalarParam,int dimensionParam,class ValueScalarParam>
inline
SlicedHexahedral<ScalarParam,dimensionParam,ValueScalarParam>::SlicedHexahedral(
	void)
...
inline
void
SlicedHexahedral<ScalarParam,dimensionParam,ValueScalarParam>::reserveVertices(
	size_t numVertices)
	{
...
inline
void
SlicedHexahedral<ScalarParam,dimensionParam,ValueScalarParam>::reserveCells(
	size_t numCells)
	{
...
inline
int
SlicedHexahedral<ScalarParam,dimensionParam,ValueScalarParam>::addSlice(
	const typename SlicedHexahedral<ScalarParam,dimensionParam,ValueScalarParam>::ValueScalar* sSliceValues)
	{
...
inline
void
SlicedHexahedral<ScalarParam,dimensionParam,ValueScalarParam>::finalizeGrid(
	void)
	{
