...
#ifndef VISUALIZATION_SIMPLICALHEXAHEDRALRENDERER_INCLUDED
#define VISUALIZATION_SIMPLICALHEXAHEDRALRENDERER_INCLUDED
...
class DataSetRenderer<SimplicalHexahedral<ScalarParam,dimensionParam,ValueParam> >
	{
	/* Embedded classes: */
	public:
	typedef SimplicalHexahedral<ScalarParam,dimensionParam,ValueParam> DataSet; // Type of rendered data set
...
#include <Templatized/SimplicalHexahedralRenderer.cpp>
#endif
