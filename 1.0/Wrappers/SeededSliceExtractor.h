...
class SeededSliceExtractor:public Visualization::Abstract::Algorithm
	...
	typedef Slice<DataSetWrapper> Slice; // Type of created visualization elements
	...
	size_t maxNumTriangles; // The maximum number of triangles to be extracted (not a hard limit; only checked after each fragment)
	...
	public:
	SeededSliceExtractor(const GLColorMap* sColorMap,const Visualization::Abstract::DataSet* sDataSet,const Visualization::Abstract::ScalarExtractor* sScalarExtractor,Comm::MulticastPipe* sPipe); // Creates a slice extractor for the given data set and scalar extractor
