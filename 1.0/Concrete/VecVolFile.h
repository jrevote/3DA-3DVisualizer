...
#ifndef VISUALIZATION_CONCRETE_VECVOLFILE_INCLUDED
#define VISUALIZATION_CONCRETE_VECVOLFILE_INCLUDED
...
class VecVolFile:public BaseModule
	{
	/* Constructors and destructors: */
	public:
	VecVolFile(void); // Default constructor
