/***********************************************************************
SlicedHexahedralRenderer - Class to render sliced unstructured
...
#define VISUALIZATION_SLICEDHEXAHEDRALRENDERER_IMPLEMENTATION

#include <Misc/ThrowStdErr.h>
#include <GL/GLGeometryWrappers.h>

#include <Templatized/SlicedHexahedralRenderer.h>

namespace Visualization {

namespace Templatized {

namespace SlicedHexahedralRendererImplementation {
...
class GridRenderer<ScalarParam,2,ValueParam>
	...
	/* Embedded classes: */
	public:
	typedef SlicedHexahedral<ScalarParam,2,ValueParam> DataSet;
...
class GridRenderer<ScalarParam,3,ValueParam>
	...
	/* Embedded classes: */
	public:
	typedef SlicedHexahedral<ScalarParam,3,ValueParam> DataSet;
	typedef typename DataSet::Box Box;
	typedef typename DataSet::Cell Cell;
	typedef typename DataSet::CellIterator CellIterator;
...
/**************************************************
Methods of class DataSetRenderer<SlicedHexahedral>:
**************************************************/

template <class ScalarParam,int dimensionParam,class ValueParam>
inline
DataSetRenderer<SlicedHexahedral<ScalarParam,dimensionParam,ValueParam> >::DataSetRenderer(
	const typename DataSetRenderer<SlicedHexahedral<ScalarParam,dimensionParam,ValueParam> >::DataSet* sDataSet)
	:dataSet(sDataSet),
...
inline
int
DataSetRenderer<SlicedHexahedral<ScalarParam,dimensionParam,ValueParam> >::getNumRenderingModes(
	void)
	{
	return 4;
	}
...
inline
const char*
DataSetRenderer<SlicedHexahedral<ScalarParam,dimensionParam,ValueParam> >::getRenderingModeName(
...
inline
void
DataSetRenderer<SlicedHexahedral<ScalarParam,dimensionParam,ValueParam> >::setRenderingMode(
...
inline
void
DataSetRenderer<SlicedHexahedral<ScalarParam,dimensionParam,ValueParam> >::glRenderAction(
	...
	switch(renderingModeIndex)
		...
		case 0:
			...
			SlicedHexahedralRendererImplementation::GridRenderer<ScalarParam,dimensionParam,ValueParam>::renderBoundingBox(dataSet->getDomainBox());
			break;
		
		case 1:
			/* Render the grid's outline: */
			SlicedHexahedralRendererImplementation::GridRenderer<ScalarParam,dimensionParam,ValueParam>::renderGridOutline(*dataSet);
			break;
		
		case 2:
			/* Render the grid's faces: */
			SlicedHexahedralRendererImplementation::GridRenderer<ScalarParam,dimensionParam,ValueParam>::renderGridFaces(*dataSet);
			break;
		
		case 3:
			/* Render the grid's cells: */
			SlicedHexahedralRendererImplementation::GridRenderer<ScalarParam,dimensionParam,ValueParam>::renderGridCells(*dataSet);
			break;
		}
	}
...
inline
void
DataSetRenderer<SlicedHexahedral<ScalarParam,dimensionParam,ValueParam> >::renderCell(
	const typename DataSetRenderer<SlicedHexahedral<ScalarParam,dimensionParam,ValueParam> >::CellID& cellID,
	GLContextData& contextData) const
	{
	/* Highlight the cell: */
	SlicedHexahedralRendererImplementation::GridRenderer<ScalarParam,dimensionParam,ValueParam>::highlightCell(dataSet->getCell(cellID));
	}
