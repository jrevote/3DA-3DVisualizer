...
class GridRenderer<2,DataSetParam>
	...
	/* Methods: */
	inline static void renderNone(const Size& cellSize,const Index& numCells)
		{
		;
		}
...
CartesianGridRenderer<DataSetParam>::getRenderingModeName(
	...
	static const char* renderingModeNames[4]=
		{
		"None","Grid Outline","Grid Faces","Grid Cells"
		};
...
CartesianGridRenderer<DataSetParam>::glRenderAction(
	...
	switch(renderingModeIndex)
		{
		case 0:
			/* Hide the grid's outline/faces/cells */
			CartesianGridRendererImplementation::GridRenderer<DataSetParam::dimension,DataSetParam>::renderNone(dataSet->getCellSize(),dataSet->getNumCells());
			break;
