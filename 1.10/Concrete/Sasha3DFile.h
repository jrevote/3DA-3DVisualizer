...
#ifndef VISUALIZATION_CONCRETE_SASHA3DFILE_INCLUDED
#define VISUALIZATION_CONCRETE_SASHA3DFILE_INCLUDED
...
class Sasha3DFile:public BaseModule
	{
	/* Constructors and destructors: */
	public:
	Sasha3DFile(void); // Default constructor
