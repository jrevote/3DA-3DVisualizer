...
#ifndef VISUALIZATION_CONCRETE_KOLLMANN0P9FILE_INCLUDED
#define VISUALIZATION_CONCRETE_KOLLMANN0P9FILE_INCLUDED
...
class Kollmann0p9File:public BaseModule
	{
	/* Constructors and destructors: */
	public:
	Kollmann0p9File(void); // Default constructor
