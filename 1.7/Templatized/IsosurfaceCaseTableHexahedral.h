...
#ifndef VISUALIZATION_TEMPLATIZED_ISOSURFACECASETABLEHEXAHEDRAL_INCLUDED
#define VISUALIZATION_TEMPLATIZED_ISOSURFACECASETABLEHEXAHEDRAL_INCLUDED
...
template <>
class IsosurfaceCaseTable<Hexahedral<3> >
	{
	/* Embedded classes: */
	public:
