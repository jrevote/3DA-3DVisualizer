...
#ifndef VISUALIZATION_CONCRETE_BYTEVOLFILE_INCLUDED
#define VISUALIZATION_CONCRETE_BYTEVOLFILE_INCLUDED
...
class ByteVolFile:public BaseModule
	{
	/* Constructors and destructors: */
	public:
	ByteVolFile(void); // Default constructor
