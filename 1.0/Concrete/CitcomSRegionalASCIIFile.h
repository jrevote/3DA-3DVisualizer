...
#ifndef VISUALIZATION_CONCRETE_CITCOMSREGIONALASCIIFILE_INCLUDED
#define VISUALIZATION_CONCRETE_CITCOMSREGIONALASCIIFILE_INCLUDED
...
class CitcomSRegionalASCIIFile:public BaseModule
	{
	/* Constructors and destructors: */
	public:
	CitcomSRegionalASCIIFile(void); // Default constructor
