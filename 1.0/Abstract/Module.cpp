...
Algorithm* Module::getScalarAlgorithm(int scalarAlgorithmIndex,const GLColorMap* colorMap,const DataSet* dataSet,const ScalarExtractor* scalarExtractor,Comm::MulticastPipe* pipe) const
	{
...
Algorithm* Module::getVectorAlgorithm(int vectorAlgorithmIndex,const GLColorMap* colorMap,const DataSet* dataSet,const VectorExtractor* vectorExtractor,const ScalarExtractor* scalarExtractor,Comm::MulticastPipe* pipe) const
	{
