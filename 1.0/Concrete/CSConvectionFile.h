...
#ifndef VISUALIZATION_CONCRETE_CSCONVECTIONFILE_INCLUDED
#define VISUALIZATION_CONCRETE_CSCONVECTIONFILE_INCLUDED

#include <Wrappers/CurvilinearIncludes.h>
#include <Concrete/CSConvectionValue.h>
...
typedef CSConvectionValue Value; // Memory representation of data set value
typedef Visualization::Templatized::Curvilinear<Scalar,3,Value> DS; // Templatized data set type
typedef CSConvectionDataValue<DS> DataValue; // Type of data value descriptor
typedef Visualization::Wrappers::Module<DS,DataValue> BaseModule; // Module base class type

}

class CSConvectionFile:public BaseModule
	{
	/* Constructors and destructors: */
	public:
	CSConvectionFile(void); // Default constructor
