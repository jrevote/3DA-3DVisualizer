...
class VariableManager
	...
	enum PaletteType // Enumerated type for palette generation types
		...
		RAINBOW,
      GOCAD_AFRICA,GOCAD_BGR,GOCAD_CLASSIC,GOCAD_FLAG,GOCAD_FLUIDS,GOCAD_GREEN_YELLOW,GOCAD_RAINBOW_0,GOCAD_RAINBOW_1,
      GOCAD_RAINBOW_2,GOCAD_RED_BLUE,GOCAD_WHITE_BLUE,
      QUALITATIVE_0,QUALITATIVE_1,QUALITATIVE_2,QUALITATIVE_3,QUALITATIVE_4,QUALITATIVE_5,QUALITATIVE_6,QUALITATIVE_7,
      DIVERGING_0,DIVERGING_1,DIVERGING_2,DIVERGING_3,DIVERGING_4,DIVERGING_5,DIVERGING_6,DIVERGING_7,
      SEQUENTIAL_0,SEQUENTIAL_1,SEQUENTIAL_2,SEQUENTIAL_3
		};
