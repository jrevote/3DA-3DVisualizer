...
class DataSet:public Visualization::Abstract::DataSet
	...
	typedef ScalarExtractor<SE> ScalarExtractor; // Compatible scalar extractor wrapper class
	typedef Visualization::Templatized::VectorExtractor<VVector,DSValue> VE; // Type of templatized vector extractor
	typedef VectorExtractor<VE> VectorExtractor; // Compatible vector extractor wrapper class
