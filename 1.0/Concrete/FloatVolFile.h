...
#ifndef VISUALIZATION_CONCRETE_FLOATVOLFILE_INCLUDED
#define VISUALIZATION_CONCRETE_FLOATVOLFILE_INCLUDED
...
class FloatVolFile:public BaseModule
	{
	/* Constructors and destructors: */
	public:
	FloatVolFile(void); // Default constructor
