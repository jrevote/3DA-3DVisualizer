...
#ifndef VISUALIZATION_CONCRETE_FLOATGRIDFILE_INCLUDED
#define VISUALIZATION_CONCRETE_FLOATGRIDFILE_INCLUDED
...
class FloatGridFile:public BaseModule
	{
	/* Constructors and destructors: */
	public:
	FloatGridFile(void); // Default constructor
