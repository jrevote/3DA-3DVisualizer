...
#ifndef VISUALIZATION_CONCRETE_MULTICITCOMTFILE_INCLUDED
#define VISUALIZATION_CONCRETE_MULTICITCOMTFILE_INCLUDED
...
class MultiCitcomtFile:public BaseModule
	{
