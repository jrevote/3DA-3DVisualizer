...
/****************************************************
Static elements of class SliceCaseTable<Hexahedral<3> >:
****************************************************/

const int SliceCaseTable<Hexahedral<3> >::edgeIndices[16][5]=
	{
	{-1, -1, -1, -1, -1}, //  0
	{ 0,  1,  2, -1, -1}, //  1
	{ 0,  4,  3, -1, -1}, //  2
...
const int SliceCaseTable<Hexahedral<3> >::neighbourMasks[16]=
	{
