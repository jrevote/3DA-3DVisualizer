...
class Module:public Visualization::Abstract::Module
	...
	virtual Visualization::Abstract::Algorithm* getScalarAlgorithm(int scalarAlgorithmIndex,const GLColorMap* colorMap,const Visualization::Abstract::DataSet* dataSet,const Visualization::Abstract::ScalarExtractor* scalarExtractor,Comm::MulticastPipe* pipe) const;
	virtual int getNumVectorAlgorithms(void) const;
	virtual const char* getVectorAlgorithmName(int vectorAlgorithmIndex) const;
	virtual Visualization::Abstract::Algorithm* getVectorAlgorithm(int vectorAlgorithmIndex,const GLColorMap* colorMap,const Visualization::Abstract::DataSet* dataSet,const Visualization::Abstract::VectorExtractor* vectorExtractor,const Visualization::Abstract::ScalarExtractor* scalarExtractor,Comm::MulticastPipe* pipe) const;
	};
