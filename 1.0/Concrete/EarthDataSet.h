...
class EarthDataSet:public DataSetBaseParam // Data set class
	...
	std::string topographyFileName; // Name of the topography file to texture-map the Earth renderer
	...
	const std::string& getTopographyFileName(void) const // Returns the topography file name
		{
		return topographyFileName;
		}
...
class EarthDataSetRenderer:public DataSetRendererBaseParam // Data set renderer class
	...
	public:
	typedef DataSetBaseParam DataSetBase; // Base class for data set wrapper class
	typedef EarthDataSet<DataSetBase> EarthDataSet;  // Type of compatible data set class
	...
	/* Private methods: */
	static const char* getTopographyFileName(const Visualization::Abstract::DataSet* sDataSet);
