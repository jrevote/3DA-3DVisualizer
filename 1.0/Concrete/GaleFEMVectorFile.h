...
#ifndef VISUALIZATION_CONCRETE_GALEFEMVECTORFILE_INCLUDED
#define VISUALIZATION_CONCRETE_GALEFEMVECTORFILE_INCLUDED
...
typedef double Scalar; // Scalar type of data set domain
...
class GaleFEMVectorFile:public BaseModule
	{
	/* Constructors and destructors: */
	public:
	GaleFEMVectorFile(void); // Default constructor
