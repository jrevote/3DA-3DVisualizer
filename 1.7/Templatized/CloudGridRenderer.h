...
#ifndef VISUALIZATION_TEMPLATIZED_CLOUDGRIDRENDERER_INCLUDED
#define VISUALIZATION_TEMPLATIZED_CLOUDGRIDRENDERER_INCLUDED
...
class CloudGridRenderer
	...
	public:
	CloudGridRenderer(const DataSet* sDataSet); // Creates a renderer for the given data set
...
#ifndef VISUALIZATION_TEMPLATIZED_CLOUDGRIDRENDERER_IMPLEMENTATION
#include <Templatized/CloudGridRenderer.cpp>
#endif
