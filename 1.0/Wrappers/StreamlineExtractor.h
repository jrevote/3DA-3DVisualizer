...
class StreamlineExtractor:public Visualization::Abstract::Algorithm
	...
	typedef Streamline<DataSetWrapper> Streamline; // Type of created visualization elements
	...
	public:
	StreamlineExtractor(const GLColorMap* sColorMap,const Visualization::Abstract::DataSet* sDataSet,const Visualization::Abstract::VectorExtractor* sVectorExtractor,const Visualization::Abstract::ScalarExtractor* sScalarExtractor,Comm::MulticastPipe* sPipe); // Creates a streamline extractor for the given data set, vector extractor, and auxiliary scalar extractor
